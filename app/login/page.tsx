...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FFF8F3] via-[#FFF5E6] to-[#FFF9F0] relative">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen px-4 py-8">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:pl-8 mt-8 lg:mt-0">
          <div className="w-full max-w-md space-y-6">
