...
const TESTIMONIALS = [
  {
    ...
    rating: 5,
    content: '아이가 수학을 싫어했는데, 홈카데미 AI 부모님과 함께하면서 논리력이 92점까지 올랐어요! 제가 직접 커리큘럼을 짜는 게 처음엔 어색했는데 이제 너무 재밌어요.',
    badge: '논리력 +40점',
  },
  {
    name: '김민수 님',
    ...
    rating: 5,
    content: '아이가 단계마다 성취를 쌓아가며 스스로 공부하려고 해요. 성장 리포트를 보면서 아이가 창의력 분야에 남다른 재능이 있다는 걸 데이터로 확인하게 되었습니다.',
    badge: '창의력 발견',
  },
  {
    name: '이수진 님',
    ...
    rating: 5,
    content: '두 아이를 동시에 관리할 수 있어서 너무 편해요. 각자 다른 AI 부모님을 배치해서 맞춤 교육이 가능하고, 비교 분석도 되니까 정말 유용합니다.',
    badge: '2자녀 동시 관리',
  },
  {
    name: '최현우 님',
